...
export const OAuthSessionSchema = z.object({
  sessionId: z.string().optional().describe("OAuth session ID for authenticated requests"),
});

// OAuth MCP Tool Schemas
export const OAuthPKCESchema = z.object({
  sessionId: z.string().optional().describe("Optional custom session ID. If not provided, a random one will be generated"),
});

export const OAuthStatusSchema = z.object({
  sessionId: z.string().describe("OAuth session ID to check status for"),
});

export const OAuthLogoutSchema = z.object({
  sessionId: z.string().describe("OAuth session ID to logout"),
});
...
export const CreateMergeRequestSchema = ProjectParamsSchema.extend(MergeRequestOptionsSchema).merge(OAuthSessionSchema);
